...
from preprocessing.compute_optical_flow import compute_dense_flow  # NEW
...
def process_directory(video_dir, label):
    ...
    Extract frames, compute FFT, residual maps, and optical flow.
    """
    for root, _, files in os.walk(video_dir):
        for f in files:
            ...
            flow_dir = os.path.join(FEATURES_DIR, "flow", label, rel_path, base_name)
            ...
            compute_dense_flow(frame_dir, flow_dir)  # NEW
